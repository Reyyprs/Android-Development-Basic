...

{
    ...
    {
        val tvJudulDoaHarian:TextView = view.findViewById(R.id.tvJudulDoaBangunTidur)
        val tvDoaArab:TextView = view.findViewById(R.id.tvDoaArab1)
        val tvDoaLatin:TextView = view.findViewById(R.id.tvDoaLatin1)
    ...
    override fun onBindViewHolder(holder: DoaHarianViewHolder, position: Int) {
        ...
        holder.tvJudulDoaHarian.text = item.judul
